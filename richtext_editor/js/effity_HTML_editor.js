...
$(document).ready(function() {
	...
	// 防止焦点丢失
	$(".ehe_menu_button,#ehe_menu").bind('mousedown',function(event){
...
//编辑框高度变换
function reset_effity_HTML_editor_height() {
	$("#ehe_main_wrapper").height($(window).height() - 170);
	$("#ehe_main_placeholder").height($(window).height() - 210);
	$("#ehe_main").css("min-height", $(window).height() - 170 + "px");
	$("#ehe_right_content").height($(window).height() - 190);
}