function ehe_before_processing(){
	...
	// 代码高亮
	$("#ehe_main").find("pre").each(function(){
		var lang = $(this).attr("data-lang") == null ? "no-highlight" : $(this).attr("data-lang");
		$(this).attr("class", lang);
		//pre_line_handler($(this));
	});
	$("#ehe_main").find("pre").each(function(i, e) {hljs.highlightBlock(e)});
