...
function effity_editor_code(){
	...
	$(".no_highlight,.highlight").click(function(){
		...
		// 菜单变换
		$(".fm_select").removeClass("fm_select");
		$(this).addClass("fm_select");
	...
	$("input[name='show_number']").click(function(){
		...
		select_pre.attr("data-show-number", show_number);
	});
...
function inner_pre_function(){
	...
	pre.mouseenter(function(){
		...
		// 菜单显示当前选择语言
		var lang = select_pre.attr("data-lang");
		$(".fm_select").removeClass("fm_select");
		if(lang == undefined)
		{
			$(".no_highlight").addClass("fm_select");
		}
		$(".no_highlight[data-lang='"+lang+"']").addClass("fm_select");
		$(".highlight[data-lang='"+lang+"']").addClass("fm_select");
		
		// 传递代码是否显示序号信息
		var show_number = select_pre.attr("data-show-number");
